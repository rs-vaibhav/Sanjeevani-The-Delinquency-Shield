...
class RiskEngine:
    ...
    def get_assessment(self, inputs):
        risk_score = self.calculate_rule_score(inputs)
        ...
        if self.model and self.feature_names:
            try:
                ...
                risk_score = self.model.predict_proba(df)[0][1] * 100
...
# ── TAB 2: calls the fragment — stays isolated ───────────────────────────────
with tab2:
    kafka_tab()
